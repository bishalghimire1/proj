...
<div class="content-body">
    ...
    <a href="{{route('sticker/form')}}"><button class="btn btn-primary btn-block">Add Sticker</button></a>

        <div class="row page-titles">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active"><a href="{{ route('home') }}">Table</a></li>
                <li class="breadcrumb-item"><a href="{{ route('home') }}">All Stickers</a></li>
            </ol>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">List Sticker</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example2" class="display" style="width:100%">
                                ...
                                <tbody>
                                    @foreach($sticker_table as $key=>$items)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a class="btn btn-primary shadow btn-xs sharp me-1 edit_sticker" href="#" data-toggle="modal" data-target="#edit_user"><i class="fas fa-pencil-alt"></i></a>
                                                <a class="btn btn-danger shadow btn-xs sharp delete_sticker" href="#" data-toggle="modal" data-target="#delete_user"><i class="fa fa-trash"></i></a>
                                            </div>												
                                        </td>	
                                    </tr>
                                    @endforeach
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('sticker/update') }}" method="POST">
                    @csrf
                    <div class="row">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="modal-btn delete-action">
                    <form action="{{ route('sticker/delete') }}" method="POST">
                        @csrf
...
@section('script')
    ...
    <script>
        $(document).on('click','.edit_sticker',function()
        {
